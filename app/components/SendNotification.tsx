  ...
  return (
    <div className="bg-white/5 rounded-xl p-6 border border-white/10 mb-8">
      <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
        <span className="w-8 h-8 bg-yellow-500/20 rounded-full flex items-center justify-center mr-3 text-lg">
          🔔
        </span>
        Push Notifications
      </h3>
      ...
      <div className="space-y-4">
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            ...
            className={`flex-1 font-semibold py-3 px-6 rounded-xl transition-all duration-200 shadow-md flex items-center justify-center ${
